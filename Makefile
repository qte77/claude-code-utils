...
check_sync:  ## Verify all copies are in sync with .claude/ SoT
	...
	@test -L plugins/workspace-sandbox/rules/unattended-execution.md || (echo "ERROR: plugins/workspace-sandbox/rules/unattended-execution.md is not a symlink" && exit 1)
